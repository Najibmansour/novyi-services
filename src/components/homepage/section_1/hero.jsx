  ...
  return (
    <section className="grid h-[88svh] w-full grid-cols-6 grid-rows-1 md:h-homepage-section">
      <div className="col-span-5 col-start-1 row-span-1 row-start-1 flex flex-col justify-center md:items-center">
        <div className="-translate-y-12 translate-x-3 md:space-y-2">
      ...
      <div className="col-span-6 col-start-1 row-span-1 row-start-1 grid h-full grid-cols-1 grid-rows-7 p-4 text-right text-xl tracking-wider md:p-8 md:text-3xl">
        <div>Auditing</div>
        <div>Card SEO</div>
        <div>Branding</div>
        <div>Marketing</div>
