  ...
  return (
    <div className="mx-5 max-w-md ">
      <div className="relative flex h-10 items-center  overflow-hidden rounded-full focus-within:shadow-lg md:w-80 md:bg-white">
        <input
          className=" hidden h-full md:pl-3 text-sm text-gray-700 outline-none md:block md:w-full"
          type="text"
          id="search"
          placeholder="Search something.."
        />
        <div className="grid h-full place-items-center text-gray-300 md:w-12 ">
          <div className="md:bg-red-700  flex flex-row justify-center items-center rounded-full mr-5 w-10 h-7 md:hover:bg-red-800 transition-all active:scale-95">
